...
const DocumentView: React.FC<DocumentViewProps> = ({ 
  ...
  const informativeStatusOptions = useMemo(() => {
    const baseKeys: DocumentStatus[] = [
      'AGENDAR_REUNIAO_REDE', 'AGUARDANDO_DOCUMENTO', 'AGUARDAR_RESPOSTA_EMAIL', 'EMAIL_RESPONDIDO',
      'ENCAMINHAR_NOTICIA_FATO', 'NOTIFICAR', 'NOTIFICADO', 'OFICIO_RESPONDIDO',
      'RESPONDER_EMAIL', 'SOLICITAR_REUNIAO_REDE', 'SOLICITAR_REUNIAO_DE_REDE',
      'CONCLUIDO', 'ENCERRADO', 'AVALIAR_EM_COLEGIADO', 'MEDIDA_PENDENTE',
